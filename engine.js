...
(function() {
  ...
  self.addEventListener('message', (function(e) {
    ...
    return self.postMessage(JSON.stringify(render(args.world, args.cam, args.width, args.height)));
  }), false);

  render = function(w, c, width, height) {
    var cam, data, tracer, world, x, y, _i, _j;
    data = [];
