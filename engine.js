...
(function() {
  var render, restoreCam, restoreLights,
    _this = this,
  ...
  restoreLights = function(lights) {
    ...
    for (_i = 0, _len = lights.length; _i < _len; _i++) {
      ...
      if (light.direction) {
        direction = new Vector3(parseFloat(light.direction.x), parseFloat(light.direction.y), parseFloat(light.direction.z));
      }
  ...
  self.addEventListener('message', function(e) {
    ...
    return render(data.startW, data.endW, data.startH, data.endH, data.width, data.height, restoreCam(data.cam), restoreLights(data.lights));
  }, false);

  render = function(startW, endW, startH, endH, width, height, cam, lights) {
