...
(function() {
  var initialize, render, restoreCam, restoreColor, restoreLights, restoreMaterial, restoreNormal, restoreObject, restoreObjects, restorePoint, restoreVector, restoreWorld,
    _this = this,
  ...
  this.SingleColorMaterial = (function() {
    ...
    function SingleColorMaterial(color) {
      var _this = this;
      this.color = color;
      this.colorFor = function(hit, world, tracer) {
        return SingleColorMaterial.prototype.colorFor.apply(_this, arguments);
      };
  ...
  this.LambertMaterial = (function() {
    ...
    function LambertMaterial(color) {
      ...
      this.color = color;
      this.colorFor = function(hit, world, tracer) {
        return LambertMaterial.prototype.colorFor.apply(_this, arguments);
      };
    }
  ...
  this.PhongMaterial = (function() {
    ...
    function PhongMaterial(diffuse, specular, exponent) {
      ...
      this.colorFor = function(hit, world, tracer) {
        return PhongMaterial.prototype.colorFor.apply(_this, arguments);
      };
    }
  ...
  this.ReflectiveMaterial = (function() {
    ...
    function ReflectiveMaterial(diffuse, specular, exponent, reflection) {
      ...
      this.colorFor = function(hit, world, tracer) {
        return ReflectiveMaterial.prototype.colorFor.apply(_this, arguments);
      };
    }
  ...
  this.TransparentMaterial = (function() {
    ...
    TransparentMaterial.maxDepth = 4;

    function TransparentMaterial(indexOfRefraction) {
      var _this = this;
      this.indexOfRefraction = indexOfRefraction;
      this.colorFor = function(hit, world, tracer) {
        return TransparentMaterial.prototype.colorFor.apply(_this, arguments);
      };
      this.recursionCounter = this.maxDepth;
    }

    TransparentMaterial.prototype.colorFor = function(hit, world, tracer) {
      var R, R0, color, cosI, cosT, n1, n2, normal, recursionCounter, t, tir;
