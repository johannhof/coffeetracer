...
(function () {
    ...
    this.Plane = (function (_super) {
        ...
        Plane.prototype.hit = function (ray) {
            var t;
            t = this.a.sub(ray.o).dot(this.n) / ray.d.dot(this.n);
    ...
    Sphere = (function (_super) {
        ...
        Sphere.prototype.hit = function (ray) {
            var a, b, cn, d, t;
            a = ray.d.dot(ray.d);
            b = ray.d.dot((ray.o.sub(this.c)).mul(2));
            cn = ray.o.sub(this.c).dot(ray.o.sub(this.c)) - (this.r * this.r);
            d = (b * b) - 4.0 * a * cn;
            t = (-b - Math.sqrt(d)) / (2.0 * a);
            if(d > epsilon) {
                if(t > epsilon) {
                    return new Hit(t, ray, this, ray.o.sub(this.c).add(ray.d.mul(t)).mul(1.0 / this.r).asNormal());
                }
                t = (-b + Math.sqrt(d)) / (2.0 * a);
                if(t > epsilon) {
                    return new Hit(t, ray, this, ray.o.sub(this.c).add(ray.d.mul(t)).mul(1.0 / this.r).asNormal());
